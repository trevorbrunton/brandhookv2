...
export function Kanban() {
  ...
  const addNewItem = (columnId: string) => {
    if (!newItemContent[columnId]) return
    ...
    setBoard((prev) => ({
      columns: {
        ...
        [columnId]: {
          ...
          items: [
            ...prev.columns[columnId].items,
            { id: newItemId, content: newItemContent[columnId] },
          ],
        },
      },
    }))
                    ...
                    >
                      ...
                      <div className="mt-2">
                        <Input
                          ...
                          className="mb-2"
                        />
                        <Button onClick={() => addNewItem(column.id)} className="w-full">
